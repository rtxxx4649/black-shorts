...
const desktopControlsCss = "@media (min-width:701px){.page-controls{display:grid!important;grid-template-columns:1fr 1fr!important;grid-template-rows:auto auto!important;gap:0!important;align-items:stretch!important}.page-controls .twitch-switch-controls,.page-controls .youtube-switch-controls{display:contents!important}.page-controls #twitchNextButton{display:block!important;grid-column:1!important;grid-row:1!important;width:100%!important;height:clamp(184px,16vw,256px)!important}.page-controls #youtubeNextButton{display:block!important;grid-column:2!important;grid-row:1!important;width:100%!important;height:clamp(184px,16vw,256px)!important}.page-controls .audio-switch-button{display:block!important;grid-column:1 / -1!important;grid-row:2!important;width:100vw!important;max-width:none!important;height:clamp(184px,16vw,256px)!important}}";
if (!html.includes("height:clamp(184px,16vw,256px)!important")) {
  const styleEnd = html.indexOf("</style>");
  if (styleEnd === -1) throw new Error("Style closing tag was not found in index2.html");
